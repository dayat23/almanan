...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { account_member_id: @testimonial.account_member_id, description: @testimonial.description }
    end
  ...
  test "should update testimonial" do
    put :update, id: @testimonial, testimonial: { account_member_id: @testimonial.account_member_id, description: @testimonial.description }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
